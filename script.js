...
const projects = [
  {
    id: '1',
    name: 'Camara Education Ethiopia',
    description: 'Camara volunteer application form',
    featured_image: './Images/camara.png',
    link_to_live: ['See live', './Images/detailProjectLive.png', 'https://emmanuel130.github.io/Cmara-Education-Volunteer-website-final/#home'],
    link_to_source: ['See source', './Images/detailProjectGit.png', 'https://github.com/Emmanuel130/Cmara-Education-Volunteer-website-final'],
    technologies: ['html', 'css', 'javascript', 'react'],
    name_detail: ['Amanuel Detebo', 'Front-End Dev', '2023'],
  },
  {
    id: '2',
    name: 'Adama city',
    description: 'Visit Adama',
    featured_image: './Images/adama.png',
    link_to_live: ['See live', './Images/detailProjectLive.png', 'https://emmanuel130.github.io/Admacity-project/'],
    link_to_source: ['See source', './Images/detailProjectGit.png', 'https://github.com/Emmanuel130/Admacity-project'],
